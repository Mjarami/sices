...
if($_POST!=null)
{
    if($_POST["visitante"]==1)
    {
        if($_POST["cedula"]!="" && $_POST["cedula"]!=null && $_POST["cedula"]!=" " && $_POST["apellido"]!="" && $_POST["apellido"]!=null && $_POST["apellido"]!=" " && $_POST["nombre"]!="" && $_POST["nombre"]!=null && $_POST["nombre"]!=" " && $_POST["unidad"]!="" && $_POST["unidad"]!=null && $_POST["unidad"]!=" ")
        {
            $cedula=$_POST["cedula"];
